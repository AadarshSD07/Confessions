...
import SocialPost from '../Components/LikeButton';
import "../CSS/App.css"
...
export default function ViewPosts() {
  ...
  const deletePost = async (e) => {
    ...
    try {
      ...
      if (response.status === 200){
        window.location.href = "/view_posts";
      } else {
  ...
  const userLikedPosts = getPostsData.userLikedPosts;
  const userComments = getPostsData.userComments;
